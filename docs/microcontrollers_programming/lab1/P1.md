...
4. Instala el controlador USB CP2104:
    ...
    - [Linux](https://m5stack.oss-cn-shenzhen.aliyuncs.com/resource/drivers/CP210x_VCP_Linux.zip) (Descomprime el archivo y sigue las instrucciones de compilación de `CP210x_VCP_Linux_4.x_Release_infos.txt`).
